    ...
    $(document).ready(function () {
        ...
        $(window).on('scroll', function() {
            ...
            if (scroll >= 200) {
                ...
                $('#headerACASIA').attr('src',"/img/acasia/acasia-25.png").attr('width','80').css('bottom','-5px');
            } else {
                $('.app-header').removeClass('sticky-nav');
                $('#headerACASIA').attr('src',"/img/acasia/acasia-25.png").attr('width','145').css('bottom','30px');
            }
        });
