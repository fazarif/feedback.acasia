...
<body>
	...
	Hi {{ ucwords($name) ?? '(Name)'}}, <br><br>

	ACASIA wishes and hope that you are doing well.<br><br>
	Although I am sure you are busy, but to improve the quality of our ticketing support, we’d really appreciate if you could rate our service by clicking on the feedback form.
	<br><br>
	...
	<br><br>Please access your <b>feedback form</b> via this link > <a href="http://feedback.acasia.net/form/{{$unique_id}}"> ACASIA Feedback</a>
