            ...
            <div class="card-body">
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" id="inputName" class="form-control" value="Maybank Support" disabled>
                </div>
                <div class="form-group col-md-6">
                  <label for="inputName">Customer Email</label>
                  <input type="text" id="inputName" class="form-control" value="support@maybank.com" disabled>
                </div>
              </div>
              <div class="row">
                <div class="form-group col-md-6">
                  <label for="inputCircId">Circuit ID</label>
                  <input type="text" id="inputCircId" class="form-control" value="MYBN - 098 - 764" name="inputCircId" readonly="re">
                </div>
                <div class="form-group col-md-6">
                  <label for="inputCircName">Circuit Name</label>
                  <input type="text" id="inputCircName" class="form-control" value="MYN - TYP" name="inputCircName" readonly="readonly">
                </div>
              </div>
              <div class="form-group" style="padding-bottom: 1.5rem;">
                <label for="inputName">Ticket Number</label>
                <input type="text" id="inputName" class="form-control" value=" ACS9000001" disabled>
              </div>
