        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="#">Feedback: SofeaRun</a></li>
              ...
              <div class="row">
                <div class="col-12" id="post-news">
                  ...
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Feedback Form: SofeaRun</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    ...
                    @csrf
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="form-group col-md-6">
                            <label for="inputTitle">Ticket ID</label>
                            <input type="text" class="form-control" id="inputTicket" placeholder="Enter ticket ID" name="formTicket" required>
                          </div>
                        </div>
                        ...
                        <input type="hidden" class="form-control" id="inputType" name="formType" value="0" required>
