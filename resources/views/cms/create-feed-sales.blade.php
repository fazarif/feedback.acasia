        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="#">Feedback: Sales</a></li>
              ...
              <div class="row">
                <div class="col-12" id="post-news">
                  ...
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Feedback Form: Sales</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
...
<!--                      <div class="form-group col-md-6">
 ...
 -->                        </div>
                        ...
                        <input type="hidden" class="form-control" id="inputType" name="formType" value="2" required>
