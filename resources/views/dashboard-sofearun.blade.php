  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CSI Report: SofeaRun</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">CSI Report: SofeaRun</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          {
            if($rating->user_name != 'Placeholder' && $rating->rating_value)
            {
                $countFilled++;
            }
            if($rating->user_name != 'Placeholder' && $rating->rating_value)
...
<!--                   <button type="button" class="btn btn-tool" data-card-widget="remove">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-5">
                    <p class="text-center">
                      <strong>SofeaRun Feedback</strong>
                    </p>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">CSI Entries Table: SofeaRun</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
