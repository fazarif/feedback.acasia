  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-8">
            <h1>NOC: Customer Satisfaction Index Form</h1>
          </div>
          <div class="col-sm-4">
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">NOC: CSI Form</h3>
            </div>
            <div class="card-body">
              <div class="row">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  <label for="inputCircId">Circuit ID</label>
                  <input type="text" id="inputCircId" class="form-control" value="{{ $ratingForm->circ_id }}" name="inputCircId" readonly="re">
                </div>
                <div class="form-group col-md-6">
                  <label for="inputCircName">Circuit Name</label>
                  <input type="text" id="inputCircName" class="form-control" value="{{$ratingForm->circ_name}}" name="inputCircName" readonly="readonly">
                </div>
              </div>
              <div class="form-group" style="padding-bottom: 1.5rem;">
                <label for="inputTicketNo">Ticket Number</label>
                <input type="text" id="inputTicketNo" class="form-control" value="{{$ratingForm->ticket_no}}" name="inputTicketNo" readonly="readonly">
              </div>
              ...
              <div class="form-group">
                ...
                <textarea id="inputText" class="form-control" rows="4" name="inputText"></textarea>
              </div>
            </div>
            <!-- /.card-body -->
          </div>
