          ...
          <div class="card card-primary">
            <div class="card-header">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="form-group col-md-12" style="padding-bottom: 1.5rem;">
                    <label for="inputName">Ticket Number</label>
                    <input type="text" id="inputTicketNo" class="form-control" value="SR000{{$ratingForm->ticket_no}}" name="inputTicketNo" readonly="re">
                  </div>
                </div>
